  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRole?.role === 'front_desk' || userRole?.role === 'admin') {
        ...
        setTimeout(() => window.location.href = '/staff/dashboard', 1000) // fallback
        return
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A3D62] to-[#082032] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#0A3D62]">Staff Access</h1>
          <p className="text-gray-500 mt-2">Atican Beach Resort Staff Portal</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="staff@aticanbeach.com"
                required
              />
            </div>
          </div>
